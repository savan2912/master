class ResponseHomeNearListing {
  String? result;
  String? message;
  List<HomeNearListing>? data;

  ResponseHomeNearListing({this.result, this.message, this.data});

  ResponseHomeNearListing.fromJson(Map<String, dynamic> json) {
    result = json['result'];
    message = json['message'];
    if (json['data'] != null) {
      data = <HomeNearListing>[];
      json['data'].forEach((v) {
        data!.add(new HomeNearListing.fromJson(v));
      });
    }
  }
...
class HomeNearListing {
  ...
  HomeNearListing.fromJson(Map<String, dynamic> json) {
    id = json['id'];
