class ResponseHomeLatestRelease {
  String? result;
  String? message;
  List<HomeLatestRelease>? data;

  ResponseHomeLatestRelease({this.result, this.message, this.data});

  ResponseHomeLatestRelease.fromJson(Map<String, dynamic> json) {
    result = json['result'];
    message = json['message'];
    if (json['data'] != null) {
      data = <HomeLatestRelease>[];
      json['data'].forEach((v) {
        data!.add(new HomeLatestRelease.fromJson(v));
      });
    }
  }
...
class HomeLatestRelease {
  ...
  HomeLatestRelease.fromJson(Map<String, dynamic> json) {
    id = json['id'];
