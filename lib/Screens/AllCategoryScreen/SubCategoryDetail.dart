...
import '../CategoryDetail/FullScreenGallery.dart';
    ...
    if (selectedIndex == 0) {
      ...
      return GridView.builder(
        ...
        gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(
          crossAxisCount: 2, // Ek row ma 2 products
          childAspectRatio: 0.75, // Card ni height/width ratio
          crossAxisSpacing: 12,
          mainAxisSpacing: 12,
        ),
      ...
      child: Stack(
        children: [
          ...
          Padding(
            ...
            child: Row(
              children: [
                // Icon pan kadhi nakhyu chhe, direct text focus
                Expanded(
                  child: Column(
                    mainAxisAlignment: MainAxisAlignment.center,
                    crossAxisAlignment: CrossAxisAlignment.start,
  ...
  Widget _buildSwiggyTab(
    ...
    return Expanded(
      child: GestureDetector(
        ...
        child: CustomPaint(
          painter: TabShapePainter(isSelected: isSelected),
          child: Container(
            height: 70,
...
class TabShapePainter extends CustomPainter {
  ...
  TabShapePainter({required this.isSelected});
  ...
  void paint(Canvas canvas, Size size) {
    ...
    /// Optional Glow Effect (Premium Look)
