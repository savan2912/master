    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            "Discover Local Services with Gotilo",
            style: GoogleFonts.playfairDisplay(
              fontSize: 24,
              fontWeight: FontWeight.bold,
              color: const Color(0xFF0D1B1E),
      ...
      child: Column(
        children: [
          ...
          _buildModernStep(
            "01",
            "Choose Location",
            "Enter your location for precision.",
            Icons.gps_fixed_rounded,
          ),
          _buildModernStep(
            "02",
            "Select Category",
            "AI-driven suggestions for your needs.",
            Icons.dashboard_customize_rounded,
          ),
          _buildModernStep(
            "03",
            "Connect & Grow",
            "Instant results with verified listings.",
            Icons.bolt_rounded,
          ),
        ],
      ),
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          _modernFaqTile(
            "The Gotilo Advantage",
            "Premium hub for local service discovery.",
          ),
          _modernFaqTile(
            "Security & Trust",
            "Every business is manually verified.",
          ),
        ],
      ),
    );
  ...
  Widget _modernFaqTile(String title, String desc) {
    return Container(
      ...
      child: ExpansionTile(
        ...
        children: [
          Padding(padding: const EdgeInsets.all(15), child: Text(desc)),
        ],
      ),
    );
  }
